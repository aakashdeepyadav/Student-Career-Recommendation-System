...
const SECTIONS = [
  {
    ...
    name: "Interests",
    icon: "🎯",
    questions: Object.values(RIASEC_QUESTIONS).flat().length,
  },
  {
    id: "skills",
    name: "Skills",
    icon: "💼",
    questions: SKILL_QUESTIONS.length,
  },
  {
    id: "subjects",
    name: "Subjects",
    icon: "📚",
    questions: SUBJECT_QUESTIONS.length,
  },
];
...
function Questionnaire() {
  ...
  const calculateProgress = () => {
    ...
    const overallProgress =
      (currentSectionIndex * 100 + sectionProgress) / SECTIONS.length;
  ...
  const handleSubmit = async () => {
    const allRiasec = Object.values(RIASEC_QUESTIONS)
      .flat()
      .every((q) => riasecResponses[q.id]);
