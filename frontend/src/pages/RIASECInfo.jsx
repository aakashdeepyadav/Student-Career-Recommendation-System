  ...
  const riasecDimensions = [
    {
      ...
      name: "Realistic",
      description:
        "People who like to work with their hands, tools, machines, and animals. They prefer practical, hands-on activities.",
      icon: "🔧",
    ...
    },
    {
      ...
      name: "Investigative",
      description:
        "People who like to observe, learn, investigate, analyze, evaluate, and solve problems. They enjoy scientific and intellectual activities.",
      icon: "🔬",
      traits: [
        "Analytical",
        "Intellectual",
    ...
    },
    {
      ...
      name: "Artistic",
      description:
        "People who like to work in unstructured situations using their creativity and imagination. They enjoy artistic, musical, and literary activities.",
      icon: "🎨",
      traits: [
        "Creative",
        "Expressive",
    ...
    },
    {
      ...
      name: "Social",
      description:
        "People who like to work with other people to help, teach, and serve. They enjoy helping, teaching, and serving others.",
      icon: "👥",
      traits: [
        "Helpful",
        "Friendly",
    ...
    },
    {
      ...
      name: "Conventional",
      description:
        "People who like to work with data, have clerical or numerical ability, and carry out tasks in detail. They prefer structured, organized activities.",
      icon: "📊",
      traits: [
        "Organized",
        "Detail-oriented",
      ...
      <div className="space-y-8 animate-fadeIn page-shell">
        ...
        <div className="hero-panel">
          <div className="relative z-10">
            <span className="hero-kicker">Career Science</span>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h1 className="text-4xl font-bold mb-2">
                  RIASEC Career Theory
                </h1>
                <p className="text-cyan-100 text-lg">
                  Understanding the foundation of your career profile
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="section-panel p-8">
          ...
          <div className="prose max-w-none">
            <p className="text-lg text-gray-700 mb-4">
              <strong>RIASEC</strong> is an acronym for six personality types
              and work environments developed by psychologist
              <strong> John L. Holland</strong> in the 1950s. It's one of the
              most widely used career assessment tools in the world.
            </p>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6 rounded-r-lg">
              ...
              <p className="text-blue-700">
                People are happiest and most successful in careers that match
                their personality type. The theory suggests that both people and
                work environments can be classified into six types:
                <strong>
                  {" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl">
                ...
                <p className="text-gray-700 text-sm">
                  Help individuals understand their interests and find careers
              ...
              <div className="p-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl">
                ...
                <p className="text-gray-700 text-sm">
                  Used in career counseling, education, and HR to match people
          ...
          <div className="space-y-6">
            <div className="relative pl-8 border-l-4 border-indigo-500">
              ...
              <p className="text-gray-700">
                John L. Holland, a psychologist at Johns Hopkins University,
                began developing his theory of vocational choice. He observed
                that people in similar occupations shared similar personality
            ...
            <div className="relative pl-8 border-l-4 border-purple-500">
              ...
              <p className="text-gray-700">
                Holland published his book "Making Vocational Choices: A Theory
                of Vocational Personalities and Work Environments" (1973),
                formally establishing the RIASEC model. The theory became widely
                adopted in career counseling.
              </p>
            </div>
            ...
            <div className="relative pl-8 border-l-4 border-pink-500">
              ...
              <p className="text-gray-700">
                RIASEC has been integrated into numerous career assessment
                tools, including the Strong Interest Inventory, O*NET, and
                various online career platforms. It's used by millions of people
                worldwide to make career decisions.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-indigo-800 text-sm">
                  A pioneering psychologist who revolutionized career
                  counseling. His RIASEC theory remains one of the most
                  influential models in vocational psychology, helping millions
                  of people find fulfilling careers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
                <div className="w-8 h-8 rounded-full bg-cyan-700 text-white text-sm font-bold flex items-center justify-center mb-3">
                  1
                </div>
                <h3 className="font-bold text-gray-800 mb-2">Assessment</h3>
                <p className="text-gray-700 text-sm">
                  Individuals answer questions about their interests,
                  preferences, and activities they enjoy or would enjoy.
                </p>
              </div>
              ...
              <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <p className="text-gray-700 text-sm">
                  Responses are scored across all six RIASEC dimensions,
                  creating a profile showing relative strength in each area.
                </p>
              </div>
              ...
              <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <p className="text-gray-700 text-sm">
                  The profile is matched with careers and work environments that
                  align with the individual's dominant types.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 bg-indigo-50 rounded-xl border border-indigo-200">
              ...
              <ul className="space-y-2 text-indigo-800">
                <li className="flex items-start space-x-2">
                  ...
                  <span>
                    <strong>Congruence:</strong> The match between a person's
                    type and their work environment
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <ArrowRightIcon className="w-5 h-5 text-indigo-600 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong>Consistency:</strong> How similar adjacent types are
                    (e.g., R and I are more similar than R and A)
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <ArrowRightIcon className="w-5 h-5 text-indigo-600 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong>Differentiation:</strong> How clearly defined a
                    person's type profile is
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <ArrowRightIcon className="w-5 h-5 text-indigo-600 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong>Holland Code:</strong> A 3-letter code representing
                    a person's top three types (e.g., "ISA" = Investigative,
                    Social, Artistic)
                  </span>
                </li>
              </ul>
        ...
        <div className="section-panel p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {riasecDimensions.map((dimension) => (
              <div
                key={dimension.code}
                className={`relative overflow-hidden rounded-xl bg-gradient-to-br ${dimension.color} p-6 text-white shadow-md hover:shadow-lg transition-all duration-300`}
              >
                <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 bg-blue-50 rounded-xl border border-blue-200">
                ...
                <p className="text-blue-800 text-sm mb-3">
                  Students answer 48 questions (8 per dimension) about their
              ...
              <div className="p-6 bg-purple-50 rounded-xl border border-purple-200">
                ...
                <p className="text-purple-800 text-sm mb-3">
                  Responses are processed to create a normalized RIASEC profile
              ...
              <div className="p-6 bg-pink-50 rounded-xl border border-pink-200">
                ...
                <p className="text-pink-800 text-sm mb-3">
                  RIASEC scores are converted into a numerical vector for
              ...
              <div className="p-6 bg-indigo-50 rounded-xl border border-indigo-200">
                ...
                <p className="text-indigo-800 text-sm mb-3">
                  RIASEC profile is matched with careers that align with the
                  student's dominant types.
                </p>
            ...
            {profile && profile.riasec_profile && (
              <div className="mt-8 p-6 bg-white rounded-xl border-2 border-indigo-200">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Here's how your RIASEC profile looks based on your
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-blue-50 rounded-xl border border-blue-200">
              ...
              <ul className="text-blue-800 text-sm space-y-2">
                ...
                <li>
                  • Work environments can also be classified by RIASEC types
                </li>
                <li>
                  • Better person-environment fit leads to job satisfaction
                </li>
