...
function Dashboard() {
  const { profile, recommendations, cluster } = useProfileStore();
  ...
  const stats = [
    {
      ...
      description: profile ? "Assessment completed" : "Start your journey",
    },
    {
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-lg mb-4">
                {profile
                  ? "View your personalized recommendations, cluster analysis, and detailed insights."
                ...
                <div className="mt-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="text-green-800 font-semibold">
                      Assessment completed! View your results and
                      recommendations.
                    </p>
                  </div>
                </div>
                    ...
                    {topRiasec && (
                      <p className="text-sm text-gray-600">
                        ...
                        <span className="font-semibold text-blue-600">
                          {topRiasec.name} {topRiasec.icon}
                        </span>{" "}
                        ({Math.round(topRiasec.value * 100)}%)
                      </p>
                    )}
                  </div>
                </div>
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Your best matches based on your assessment
                  </p>
                </div>
              </div>
              <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="card p-6 hover:shadow-lg transition-all duration-200">
            ...
            <p className="text-gray-600 mb-4">
              Our system uses <strong>dual clustering algorithms</strong>{" "}
              (KMeans++ and KMeans with Random Initialization) and automatically
              selects the best-performing one based on comprehensive deployment
              metrics including clustering quality, training speed, and model
              complexity.
            </p>
            <div className="mb-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
              <p className="text-sm text-blue-800">
                <strong>Advanced Selection:</strong> The system trains both
                algorithms, compares their performance, and automatically uses
                the optimal one for your assessment analysis.
              </p>
            </div>
            <Link
              to="/model-statistics"
          ...
          <div className="card p-6 hover:shadow-lg transition-all duration-200">
            ...
            <p className="text-gray-600 mb-4">
              Interactive 2D and 3D visualizations help you understand your
              position in the career landscape and explore nearby opportunities.
            </p>
