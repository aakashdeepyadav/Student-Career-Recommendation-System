...
function ModelStatistics() {
  ...
  const selectedAlgoRaw =
    deploymentMetrics?.selected_algorithm ||
    stats?.model_info?.algorithm ||
    "KMeans++";
  const selectedAlgorithm =
    selectedAlgoRaw.toLowerCase().includes("kmeans++") ||
    selectedAlgoRaw.toLowerCase().includes("kmeans_plus") ||
    selectedAlgoRaw.toLowerCase() === "kmeans"
      ? "kmeans_plus"
      : "kmeans_random";
      ...
      <div className="space-y-6 animate-fadeIn">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                    ...
                    <span className="font-bold text-slate-900">
                      {kmeansPlusMetrics?.clustering_quality?.silhouette?.toFixed(
                        4,
                      ) || "N/A"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                    ...
                    <span className="font-bold text-slate-900">
                      {kmeansPlusMetrics?.clustering_quality?.calinski_harabasz?.toFixed(
                        2,
                      ) || "N/A"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                    ...
                    <span className="font-bold text-slate-900">
                      {kmeansPlusMetrics?.clustering_quality?.davies_bouldin?.toFixed(
                        4,
                      ) || "N/A"}
                    </span>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                    ...
                    <span className="font-bold text-slate-900">
                      {kmeansPlusMetrics?.performance?.cluster_stability?.toFixed(
                        4,
                      ) || "N/A"}
                    </span>
                  </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                    ...
                    <span className="font-bold text-slate-900">
                      {kmeansRandomMetrics?.clustering_quality?.silhouette?.toFixed(
                        4,
                      ) || "N/A"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                    ...
                    <span className="font-bold text-slate-900">
                      {kmeansRandomMetrics?.clustering_quality?.calinski_harabasz?.toFixed(
                        2,
                      ) || "N/A"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                    ...
                    <span className="font-bold text-slate-900">
                      {kmeansRandomMetrics?.clustering_quality?.davies_bouldin?.toFixed(
                        4,
                      ) || "N/A"}
                    </span>
                  </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                    ...
                    <span className="font-bold text-slate-900">
                      {kmeansRandomMetrics?.performance?.training_time_seconds
                        ? formatTime(
                            kmeansRandomMetrics.performance
                  ...
                  <div className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                    ...
                    <span className="font-bold text-slate-900">
                      {kmeansRandomMetrics?.performance?.cluster_stability?.toFixed(
                        4,
                      ) || "N/A"}
                    </span>
                  </div>
              ...
              <div className="bg-white rounded-lg p-4">
                ...
                <p
                  className={`text-2xl font-bold ${
                    comparison.speed_advantage === "KMeans (Random)"
                      ? "text-purple-600"
                      : "text-blue-600"
                  }`}
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <p className="text-2xl font-bold text-slate-900">
              {stats?.model_info?.algorithm || "N/A"}
            </p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <p className="text-2xl font-bold text-slate-900">
              {stats?.data_info?.n_students || 0}
            </p>
            <p className="text-sm text-slate-500 mt-1">
              Students in dataset ({stats?.data_info?.feature_dimension || 0}D
              features)
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            <div className="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> Showing legacy metrics. Please restart
                the ML engine server to see advanced deployment metrics with
                dual algorithm comparison.
              </p>
            </div>
            <h2 className="text-xl font-bold text-slate-900 mb-6">
              Clustering Quality Metrics (Active Algorithm Only)
            </h2>
              ...
              <div className="border border-slate-200 rounded-xl p-5">
                ...
                {stats?.metrics?.silhouette_score ? (
                  <>
                    ...
                    <span
                      className={`inline-block mt-2 px-3 py-1 rounded-full text-sm font-medium ${getScoreColor(stats.metrics.silhouette_score.interpretation)}`}
                    >
              ...
              <div className="border border-slate-200 rounded-xl p-5">
                ...
                {stats?.metrics?.davies_bouldin_score ? (
                  <>
                    ...
                    <span
                      className={`inline-block mt-2 px-3 py-1 rounded-full text-sm font-medium ${getScoreColor(stats.metrics.davies_bouldin_score.interpretation)}`}
                    >
                ...
                data={[
                  {
                    ...
                    labels: Object.keys(stats.cluster_info.cluster_sizes).map(
                      (k) =>
                        stats.cluster_info.cluster_names[k] || `Cluster ${k}`,
                    ),
                  ...
                  <tbody>
                    {stats.cluster_info.cluster_centers?.map((center, idx) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-2 text-right text-slate-700">
                          {stats.cluster_info.cluster_percentages[
                            center.cluster_id
                          ] || 0}
                          %
                        </td>
        ...
        {stats?.elbow_data && stats.elbow_data.length > 0 && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <p className="text-sm text-slate-500 mb-4">
                Cluster quality for different k values
              </p>
              <Plot
                data={[
                  {
                    ...
                    marker: {
                      color: stats.elbow_data.map((d) =>
                        d.k === stats.model_info.n_clusters
                          ? "#1e293b"
                          : "#94a3b8",
                      ),
                    },
        ...
        {stats?.pca_info?.explained_variance_ratio && (
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <p className="text-sm text-slate-500 mb-4">
              Dimensionality reduction quality - Total variance explained:{" "}
              {(stats.pca_info.total_variance_explained * 100).toFixed(1)}%
            </p>
            <Plot
              data={[
                {
                  x: stats.pca_info.explained_variance_ratio.map(
                    (_, i) => `PC${i + 1}`,
                  ),
                  y: stats.pca_info.explained_variance_ratio.map(
                    (v) => v * 100,
                  ),
                  type: "bar",
                  name: "Individual",
                ...
                {
                  x: stats.pca_info.cumulative_variance.map(
                    (_, i) => `PC${i + 1}`,
                  ),
